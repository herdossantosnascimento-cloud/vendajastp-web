  ...
  return (
    <div className="mt-6 grid gap-6 md:grid-cols-2">
      <Link
        ...
        className="block rounded-2xl border border-slate-200 bg-white/80 p-6 shadow-sm transition hover:shadow-md backdrop-blur dark:border-slate-800 dark:bg-slate-900/60"
      >
      ...
      <Link
        ...
        className="block rounded-2xl border border-amber-300 bg-amber-50/70 p-6 shadow-sm transition hover:shadow-md backdrop-blur dark:border-amber-700 dark:bg-amber-900/20"
      >
